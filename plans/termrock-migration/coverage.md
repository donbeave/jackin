...
| F2 | Every surface re-platformed where upstream equivalent exists | §Capabilities b2, D3/D12 | spec/console-modernization.md (console slice) | 006, 008, 009, 010, 011, 012, 013 (console slice) | console slice active this package; capsule/launch/small deferred (own finalizations) |
| F3 | Brand compositions re-implemented on new primitives, look unchanged | §Capabilities b3, D4/D8/D11/D13 | spec/brand-preservation.md (bump-PR compensation half); spec/console-brand-header.md (console rebuild) | 003 (bump half); 007 (console BrandHeader rebuild) | covered (bump half); console half active this package; launch/capsule rebuilds deferred (owning surfaces' phases; B11) |
| F4 | Key screens gain zero-tolerance PNG baselines via termrock-raster | §Capabilities b4, D6 | spec/png-baselines.md (console set + CI lane) | 005 (console slice) | console slice active this package; other surfaces deferred (their phases) |
...
| W2 | Console journeys unchanged through re-platforming; keyboard_help is additive, not a journey step | all console screens | spec/console-modernization.md | 008, 009, 010, 011, 012, 013 | new (console package) |
