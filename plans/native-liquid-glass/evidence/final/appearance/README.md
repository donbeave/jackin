...
- Usage: [`usage-clear-F02.png`](usage-clear-F02.png), captured `2026-08-13T03:22:20Z`; real layer-0 key window.
- Popover: [`popover-clear-F02.png`](popover-clear-F02.png), captured `2026-08-13T03:22:04Z`; real layer-25 transient surface.
- Product/test source: `6bdb98924f51607442f730f5242f3d1d041a2c5b`.
- Application SHA-256: `58b271ece95f28e81e9682fa0e09418bc4445b266c09b323241bc2bfc92f2569`.
...
The receipt and attestation below remain authoritative for the system preference, but these two app captures predate D-005 and are historical until recaptured.
