...
// Wordmark — carries the "by tailrocks" byline; shown on every logo (header,
// sidebar, landing nav, TOC, footer). The lockup is kept as an explicit alias
// for surfaces that opt in via BrandMark's byline prop.
