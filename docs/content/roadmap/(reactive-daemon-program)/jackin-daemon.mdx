...
1. **Desktop-ready API.** Add the small versioned endpoints [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/) needs first: `daemon/hello`, workspace/session discovery, GitHub PR lookup, account status, event subscription, Ghostty/browser open actions.
