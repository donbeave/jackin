...
- [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/) — native macOS surface that should eventually show host-bridge approvals and audit entries, with daemon policy/execution staying the source of truth.
