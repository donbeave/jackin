...
4. **Click-to-focus**: Ghostty first, matching the [Desktop Agent Hub](/research/product/desktop/agent-hub/) v1 contract; other terminals get a notification with no click action until their adapters are added.
...
- [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/) — owns the first Ghostty click-to-focus UX.
