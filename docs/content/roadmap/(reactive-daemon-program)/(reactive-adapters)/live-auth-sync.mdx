...
- [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/) — native account/status surface that would read live auth and quota state from the daemon first.
