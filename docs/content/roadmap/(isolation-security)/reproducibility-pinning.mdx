...
Design details, schema sketch, and open questions needing operator sign-off before implementation: [Role repo pinning: design](/research/platform/security/supply-chain/role-repo-pinning-design/).
