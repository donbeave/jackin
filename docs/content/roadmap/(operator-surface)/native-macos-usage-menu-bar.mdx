...
Coordinator completion also requires a recorded Apple Silicon macOS 26 + Docker
Desktop `cargo xtask ci --e2e` run. OrbStack proof is provisional only. Capsules see
