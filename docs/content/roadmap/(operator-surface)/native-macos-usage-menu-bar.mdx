...
Do not retire this roadmap item until public Developer ID/cask proof and the capture-gated provider requirement have authoritative evidence. The native implementation may be complete inside the repository while the broader delivery item remains **Partially implemented**.
