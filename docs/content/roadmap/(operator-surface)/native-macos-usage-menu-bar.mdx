...
- Retained native Usage `NSWindow` with `NSSplitViewController`, full-height sidebar, Overview table, provider detail list, detail-centered product identity, native toolbar/menu commands, no `Usage` title, and stable sidebar-button coordinates.
