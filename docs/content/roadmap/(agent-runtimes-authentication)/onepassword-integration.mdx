...
**Current state**: env references, console picker, per-reference account pinning, and Claude-token writes are shipped; read-only secret file mounts remain future work
