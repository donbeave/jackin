...
**Current state**: baseline shipped, override API unimplemented
...
Research: [Agent Launch Flags API: Design Options](/research/agents/runtimes/agent-launch-flags-api-design/) has the proposed static-manifest + runtime-API shape, phasing, and open design questions.
...
- Research: [Agent Launch Flags API: Design Options](/research/agents/runtimes/agent-launch-flags-api-design/) — proposal, phasing, open questions.
