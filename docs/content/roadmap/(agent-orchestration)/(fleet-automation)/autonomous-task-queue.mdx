...
2. Durable task table and idempotent source polling integration, once the [Task source abstraction](/roadmap/task-source-abstraction/) and [Persistent storage layer](/research/agents/orchestration/memory/) land.
...
Full design rationale, config sketch, prior-art comparison (multicode), and open questions live in [Autonomous Task Queue: Design Exploration](/research/agents/orchestration/fleet-operations/).
...
- [Autonomous Task Queue: Design Exploration](/research/agents/orchestration/fleet-operations/) — problem framing, multicode comparison, recommended shape, open questions.
