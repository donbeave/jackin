...
2. Non-Docker backend translation of the same grants (Apple `container`, or any future backend) — blocked on [selectable sandbox backends](/research/platform/security/sandbox-backends/) landing a second backend to translate into.
...
- [Selectable sandbox backends](/research/platform/security/sandbox-backends/) — cross-backend translator lives here long-term
