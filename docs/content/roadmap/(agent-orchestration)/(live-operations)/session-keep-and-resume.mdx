...
- [Session Keep and Resume Design](/research/agents/orchestration/recovery/session-keep-and-resume-design/) — full design notes, TUI mockups, restore-tier ladder, and audit findings.
...
- [Déjà Vu](/research/agents/orchestration/conversation-capture/deja-vu/) — the backstop for "never lose valuable context": even when a session is unrecoverable, the cross-agent conversation archive survives instance teardown.
