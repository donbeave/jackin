...
**Current state**: the launch cockpit itself has shipped; remaining work is diagnostics-tool polish, richer visual/PTY coverage, timing presentation for [Instant launch architecture](/roadmap/instant-launch-architecture/), and measured safe parallelization.
