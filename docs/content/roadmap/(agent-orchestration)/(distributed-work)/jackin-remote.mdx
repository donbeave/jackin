...
- Research: [jackin-remote design research](/research/agents/orchestration/remote-execution/) — multicode inspiration, config/CLI sketches, handler relay design, and open design questions.
