...
Design rationale, the alternatives considered for the host signal (file vs. exit code vs. control frame), and the agreed TUI mockup for the exit modal are captured in [In-Capsule Dirty-Exit: Design Rationale and Implementation Record](/research/platform/runtime/in-capsule-dirty-exit-design/).
...
- Research: [In-Capsule Dirty-Exit: Design Rationale and Implementation Record](/research/platform/runtime/in-capsule-dirty-exit-design/)
