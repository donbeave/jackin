...
- Research: [Spec-driven workflow: prior art and alternatives](/research/engineering/documentation/spec-workflow/) — why `obra/superpowers`, OpenSpec, and `gotalab/cc-sdd` were mined but not adopted wholesale.
