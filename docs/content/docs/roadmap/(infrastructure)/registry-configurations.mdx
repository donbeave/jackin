...
**Current state**: design proposal, nothing shipped yet
...
Design details — provider mechanics, config surface, ADRs on each decision above, and open questions — live in [Registry Configurations: design](/research/platform/security/credential-exposure/registry-configurations-design/).
...
- [Registry Configurations: design](/research/platform/security/credential-exposure/registry-configurations-design/) — provider mechanics, config surface, decision rationale, and source material.
...
- [Container Credential Exposure — Beyond Env Injection](/research/platform/security/credential-exposure/container-credential-exposure/) — resolved credentials must not leak into layers, `docker inspect`, or logs.
