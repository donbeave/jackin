...
**Current state**: Phase 1 (config file versioning) and Phase 2 (role manifest versioning) shipped; Phase 3 (`--pr` auto-migration) and Phase 4 (Renovate-style migration GitHub Action) remain open (Configuration ergonomics)
...
- Research: [Renovate-style role-manifest migration automation](/research/platform/runtime/config-versioning-migration-design/) — Phase 3/4 design proposal, prior-art comparison to Renovate, and open design questions for the CI automation.
