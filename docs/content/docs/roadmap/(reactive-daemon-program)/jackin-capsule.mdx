...
- Research: [Multiplexer rewrite design history](/research/agents/orchestration/jackin-capsule-multiplexer-rewrite/) — why the rewrite happened, Zellij/Herdr borrows, tmux/Ghostty compatibility rationale.
- Research: [Agent Orchestration Program](/research/agents/orchestration/program-research/) — the full Herdr-vs-jackin❯ comparative table.
...
- [jackin❯ Desktop Agent Hub](/research/product/desktop/agent-hub/jackin-desktop-agent-hub/) — consumes the daemon's aggregated view once Phase 4 ships.
