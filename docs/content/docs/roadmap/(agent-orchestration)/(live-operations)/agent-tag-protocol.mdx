...
**Current state**: design proposal only, no code shipped (Phase 2, [Agent Orchestration Program](/research/agents/orchestration/program-research/))
...
- Persistence of tag history — V1 is in-memory only; [persistent storage layer](/research/agents/orchestration/memory/persistent-storage-layer/) would add it later.
...
- Research: [Agent Tag Protocol: Design Exploration](/research/product/operator-experience/agent-tag-protocol-design/) — multicode inspiration, vocabulary rationale, parser placement, and open design questions.
