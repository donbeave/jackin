...
**Current state**: blocked on the [Native APM Support](/research/agents/runtimes/package-manager-support/native-apm-role-support/) decision; no `[skills]` config, collection layer, or mount implementation exists yet.
...
- Research: [Workspace Skills Mount: Design Options](/research/agents/runtimes/package-manager-support/workspace-skills-mount-design/) — problem statement, fallback mount-only design, and deferred scope.
- [Native APM Support for jackin❯ Agent Roles](/research/agents/runtimes/package-manager-support/native-apm-role-support/) — the strategic direction this item is blocked on.
