...
3. **Scope.** Lint only `docs/content/docs/`, or also repo-root markdown (<RepoFile path="README.md">README.md</RepoFile>, `CHANGELOG.md`, <RepoFile path="AGENTS.md">AGENTS.md</RepoFile>, `RULES.md`, <RepoFile path="TESTING.md">TESTING.md</RepoFile>, <RepoFile path="PROJECT_STRUCTURE.md">PROJECT_STRUCTURE.md</RepoFile>, `DEPRECATED.md`, `CONTRIBUTING.md`)? Those root files are read by humans and agents from session start, so their style consistency arguably matters at least as much as the docs site's.
