...
description: Build, binding, native app, and release commands proven by the Desktop CI stack
---
...
- `cargo xtask desktop bindings` then
  ...
  — CI step, <RepoFile path=".github/workflows/ci.yml" /> (around lines 1150–1152); requires
