---
title: "19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives"
---

# 19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives
...
itself. Tellingly, ast-grep's own materials (`astgrep.com`, the AI-rules blog)
...
<RepoFile path="docs/content/docs/research/platform/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx">docs/content/docs/research/platform/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx</RepoFile>.
...
## Vector databases (Qdrant) — a separate question, answered in [20 — Qdrant and vector databases](/research/context/tools/20-qdrant-and-vector-databases/)
...
[20 — Qdrant and vector databases for agent context](/research/context/tools/20-qdrant-and-vector-databases/).
...
- Augment Context Engine / MCP: [https://docs.augmentcode.com/introduction](https://docs.augmentcode.com/introduction)
...
- ast-grep core: [https://astgrep.com/](https://astgrep.com/) · AI-prompting docs (four integration modes, no token claims) [https://astgrep.com/advanced/prompting.html](https://astgrep.com/advanced/prompting.html)
...
- ast-grep CLI/skill decision record for jackin❯ roles: <RepoFile path="docs/content/docs/research/platform/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx">docs/content/docs/research/platform/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx</RepoFile>
