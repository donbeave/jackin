...
The round-2 findings sharpen — and in two cases change — what the [jackin❯ Context Engine spec](/research/context/engine/) takes:
...
| caveman family | [14 — caveman ecosystem](/research/context/tools/14-caveman-ecosystem/) |
