...
- **The dossier already covered the category, but not Qdrant specifically.**
  [08 — Retrieval, memory, and state offloading](/research/context/techniques/08-retrieval-memory-and-state/) called semantic/RAG repo indexing the largest evidence gap; [13 — Infrastructure-level](/research/context/techniques/13-infrastructure-level/)
  rejected semantic response caching for coding agents; [19 — Code-intelligence tools](/research/context/tools/19-code-intelligence-tools/) compared
...
|---|---|---|
| [08 — Retrieval, memory, and state offloading](/research/context/techniques/08-retrieval-memory-and-state/) | Semantic/RAG repo indexes may improve accuracy, but token savings vs agentic grep/read are unmeasured; validation protocol required. | Names Qdrant and scores whether it should be the backend for that protocol. |
| [13 — Infrastructure-level (self-hosted / gateway tier)](/research/context/techniques/13-infrastructure-level/) | Qdrant appears as a possible semantic-cache backend in LiteLLM; semantic response caching is a poor fit for coding agents. | Separates Qdrant-as-vector-store from semantic whole-response caching. |
| [19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/research/context/tools/19-code-intelligence-tools/) | Compares codedb, fff, CodeGraff, Serena, Code Context Engine, Claude Context, Sourcegraph, Qodo, and others. | Adds the raw vector database layer beneath Code Context Engine / Claude Context. |
...
- whole-response semantic caching, which [13 — Infrastructure-level](/research/context/techniques/13-infrastructure-level/) already killed for coding
  agents.
...
- Turbopuffer documentation: [https://turbopuffer.com/docs](https://turbopuffer.com/docs)
...
- Existing semantic/RAG discussion: [08 — Retrieval, memory, and state offloading](/research/context/techniques/08-retrieval-memory-and-state/)
- Existing semantic-cache discussion: [13 — Infrastructure-level (self-hosted / gateway tier)](/research/context/techniques/13-infrastructure-level/)
- Existing code-intelligence comparison: [19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/research/context/tools/19-code-intelligence-tools/)
