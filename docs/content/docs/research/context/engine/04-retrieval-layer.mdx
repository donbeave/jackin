...
| Semantic (fuzzy concept recall) | **none by default** | — | Deliberately absent: embeddings for code navigation never met the ≥20% bar ([tools hub 20 — Qdrant and vector databases for agent context](/research/context/tools/20-qdrant-and-vector-databases/)); optional docs-corpus hybrid index stays a role-level experiment |
