...
This folder is the **product specification** distilled from two research corpora — the [token-optimization-techniques dossier](/research/context/techniques/) (Volumes I–III, 160+ technique records, per-file verification ledgers) and the [token-optimization tools hub](/research/context/tools/) (source-level teardowns of caveman, headroom, RTK, lean-ctx) — plus a dedicated reuse-surface sweep of seven external tools ([sem](https://github.com/Ataraxy-Labs/sem), [fff](https://github.com/dmtrKovalenko/fff), [rtk](https://github.com/rtk-ai/rtk), [lean-ctx](https://github.com/yvgude/lean-ctx), [codedb](https://github.com/justrach/codedb), [mq](https://github.com/harehare/mq), [headroom](https://github.com/headroomlabs-ai/headroom)) recorded in [13 — Reuse surfaces and deltas](/research/context/tools/13-reuse-surfaces-and-deltas/) and [25 — sem and mq](/research/context/tools/25-sem-and-mq-structural-and-markdown-retrieval/), first run 2026-07-03 and re-run 2026-07-05. The 2026-07-05 re-research also feeds the spec: the [latest-versions refresh](/research/context/tools/18-latest-versions-refresh/) (per-tool delta ledger across the whole hub), the [pxpipe teardown](/research/context/tools/17-pxpipe-design/) (the one new tool that cleared the coverage bar), and the techniques [drift delta](/research/context/techniques/28-drift-delta/) (provider/docs drift against live primary sources). It specifies **one engine, embedded in jackin❯, that takes the best-evidenced mechanism from each tool and drops every cost those tools pay for not owning the runtime**.
...
The dossier's measured invariants bound the design (all sourced in [01 — economics](/research/context/techniques/01-economics-and-measurement/), [02 — baseline audit](/research/context/techniques/02-baseline-audit/), [10 — first-party measurements](/research/context/tools/10-first-party-measurements/)):
