...
- **Composability:** applies to MCP schema design (see [02 — Baseline Audit of This Environment (Phase 0)](/research/context/techniques/02-baseline-audit/) tool-schema overhead) and any codegen target.
...
| Phase-0 ground truth: thinking 54.8% of output; wenyan-full 80.9% chars→56.6% tokens; wenyan-ultra 74.5%; caveman-ultra 58.5%; Fable premium ~+15% code / ~+38% prose corpus; day split 32/29/20/17/2 | Local Phase-0 measurement (see [01 — Token Economics and Measurement](/research/context/techniques/01-economics-and-measurement/)) |
