...
- **Composability:** the denominator for every percentage in this file; this machine's own numbers in [02 — Baseline Audit of This Environment (Phase 0)](/research/context/techniques/02-baseline-audit/).
...
| caveman local: ultra 58.5%; wenyan-full 56.6% tok / 80.9% chars; wenyan-ultra 74.5%; CJK ~1.47 chars/tok; tool deferral 1,420 -> ~60 (96%); prompt mix 0.44/6.73/92.83%; dollar split 32/29/20/17/2; thinking 54.8% of output; day ~$22 | local measurement (phase-0); profile detailed in [01 — Token Economics and Measurement](/research/context/techniques/01-economics-and-measurement/) |
