...
`message.id`** (trap documented in [02 — Baseline Audit of This Environment (Phase 0)](/research/context/techniques/02-baseline-audit/) §1).
...
| JSONL dedup + thinking-redaction traps | Local measurement, [02 — Baseline Audit of This Environment (Phase 0)](/research/context/techniques/02-baseline-audit/) |
