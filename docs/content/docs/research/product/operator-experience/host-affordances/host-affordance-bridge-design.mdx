...
Phase 0 Ghostty paste/click/motion measurements, `Cmd`/`Ctrl`/`Alt` modifier visibility, OrbStack transport probing, Amp `xclip` behavior, and GitHub CI URL query shape are captured in the [preflight page](/research/product/operator-experience/host-affordances/host-affordance-bridge-preflight/).
...
- [Host Affordance Bridge Preflight](/research/product/operator-experience/host-affordances/host-affordance-bridge-preflight/) — Phase 0 measurements that grounded this design.
