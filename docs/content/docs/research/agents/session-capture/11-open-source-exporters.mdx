...
**Research conducted:** 2026-07-03; stars and activity dates from the GitHub API on that date (tier B/C — repos and readmes; none source-audited except where noted). Record schema per the [brief](/research/agents/session-capture/prompt/). Baseline for comparison: SpecStory CLI, 1,268★, Apache-2.0.
