...
**Research conducted:** 2026-07-03. This chapter maps the evidence onto jackin❯. It makes no design decisions — feature shape belongs to a `brainstorm` run against [Déjà Vu](/research/agents/orchestration/conversation-capture/deja-vu/), which is the existing design proposal this dossier now underpins.
