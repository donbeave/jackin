...
**Research state**: Open — design proposal (Containment track, [Agent Orchestration Program](/research/agents/orchestration/program-research/)). Roadmap tracking: [Session snapshot and rollback](/roadmap/session-snapshot-rollback/).
...
- Use integration-provided excludes from [stack integration contracts](/roadmap/stack-integration-contracts/).
...
- Integrate with [container credential exposure](/research/platform/security/credential-exposure/container-credential-exposure/) so secret handling stays explicit.
...
- [Persistent storage layer](/research/agents/orchestration/memory/persistent-storage-layer/) — future metadata store
