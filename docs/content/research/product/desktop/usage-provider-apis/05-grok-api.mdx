---
title: "05 — Grok usage API"
description: Documents Grok billing windows, plan labels, authentication, wire-field uncertainty, and presentation semantics.
---
...
- [xAI developer rate limits](https://docs.x.ai/developers/rate-limits)
