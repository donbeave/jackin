---
title: "11 — Amp Free daily-quota semantics"
description: Verifies Amp Free daily-quota output and identifies the parser behavior needed to represent it accurately.
---
