...
**Research state**: Design exploration for [Agent tag protocol](/roadmap/agent-tag-protocol/) (Phase 2, [Agent Orchestration Program](/research/agents/orchestration/program-research/)) — not yet implemented
