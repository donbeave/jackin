---
title: "Agent Tag Protocol: Design Exploration"
description: Defines a structured agent-tag protocol for attention requests, status signals, and operator-facing routing.
---
...
A typed tag protocol should distinguish attention requests from status signals and route both through one operator-visible channel.

This exploration informs [Agent tag protocol](/roadmap/agent-tag-protocol/) in the [Agent Orchestration Program](/research/agents/orchestration/program-research/).
