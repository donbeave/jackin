...
**Research state**: Design rationale behind [Console Agent Session Control](/roadmap/console-agent-session-control/) (Phase 2, [Agent Orchestration Program](/research/agents/orchestration/program-research/)) — the tree-view, instance-row actions, and hardline integration described here have shipped; this page keeps the product-model reasoning that motivated the shape, out of the roadmap item's day-to-day tracking.
