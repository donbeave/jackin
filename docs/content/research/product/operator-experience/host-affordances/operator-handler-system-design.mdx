...
**Research state**: Design exploration for [Operator handler system](/roadmap/operator-handler-system/) (Phase 1, [Agent Orchestration Program](/research/agents/orchestration/program-research/)) — not yet implemented
