...
**Research state**: Implemented — this is the design record for a shipped feature; see [Runtime Restore and Image Architecture](/roadmap/instant-launch-architecture/) for current roadmap status and remaining work.
