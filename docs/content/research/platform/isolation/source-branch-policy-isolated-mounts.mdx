...
description: Defines source-branch policy for isolated mounts through product behavior, TUI flows, data modeling, and open design questions.
---

## Summary

Isolated mounts need an explicit source-branch policy represented consistently in configuration, resolution, and operator prompts.
