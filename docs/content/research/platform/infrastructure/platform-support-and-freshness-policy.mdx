...
description: Explains platform-support boundaries and proposes freshness metadata that keeps roadmap claims reviewable.
---

## Summary

Platform promises need explicit support boundaries, and freshness metadata is required to keep roadmap claims reviewable.
...
The proposed contributor-facing reference page (`docs/content/reference/platform-support.mdx`) declares:
...
- [/research/platform/isolation/smolvm-backend/](/research/platform/isolation/smolvm-backend/) — Linux/KVM support affects the platform matrix.
