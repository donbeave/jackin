...
description: Designs secure registry configuration delivery across host, capsule, runtime, and credential-source boundaries.
---
...
Registry credentials should resolve through the shared credential boundary and reach runtimes without persistent capsule copies.

This proposal informs [Registry configurations](/roadmap/registry-configurations/); implementation commitments remain in the roadmap.
...
- [Credential Source Pattern — Design](/research/platform/security/credential-exposure/credential-source-pattern/) — the unified sourcing abstraction this item makes concrete and consumes.
