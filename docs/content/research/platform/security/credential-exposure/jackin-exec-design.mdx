---
title: "jackin-exec design rationale"
description: Records the threat model and architecture for releasing credentials only to an authorized on-demand command.
---
