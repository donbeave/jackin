...
**Research state**: Reference — captures why rumdl was selected as the mechanical markdown linter for the docs corpus, and the alternatives rejected. See [Docs markdown linting (rumdl)](/roadmap/docs-markdown-linting/) for the current implementation state.
