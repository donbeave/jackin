...
description: "Crate boundaries, processing layers, data flow, policies, and failure behavior for the jackin❯ context engine."
---
...
Role-facing configuration is a new versioned `[context]` table in `jackin.role.toml` (schema change per PRERELEASE rules — one version bump, 5 artifacts): see [10 — Rollout](/research/context/engine/10-rollout-and-validation/) for the field sketch.
