...
description: "Design for concise output registers, prompt guards, subagent reports, codebooks, and quality instrumentation."
---

## Summary

Generated role policy should enforce concise, evidence-preserving output and bounded subagent reports without adding a separate plugin or per-turn injection layer.
...
| `terse` (default) | plain terse-instruction: drop pleasantries/filler/hedging, complete sentences | captures most of the realizable win at lowest misread risk ([techniques 09 — Output discipline and structured generation](/research/context/techniques/09-output-discipline/): register ladder −54% at "plain") |
