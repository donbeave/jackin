...
# 06 — Context architecture — what enters the window at all
...
- Prefix economics compound through caching: every 10K of always-on prefix ≈ $0.01/turn in cache reads ≈ **$1.89/day** on the modeled profile (114 reads + 6 writes/day). Cache reads are 32% of heavy-session dollars (local Phase-0; see [01 — Token Economics and Measurement](/research/context/techniques/01-economics-and-measurement/)).
