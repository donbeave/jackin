...
# 08 — Retrieval, memory, and state offloading
...
- **Composability:** multiplies with prompt caching (smaller stable prefix, see [07 — Caching exploitation](/research/context/techniques/07-caching-exploitation/)); survives /compact (root index re-injected from disk); topic files compress further with caveman-compress (local phase-0: 58.5% token cut on prose). Anti-synergy: none known.
