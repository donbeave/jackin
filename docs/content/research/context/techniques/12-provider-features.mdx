...
# 12 — Provider-level features, current and beta
...
| 54.8% thinking share; 0.44/6.73/92.83% prompt mix; 32/29/20/17/2% dollar split; ~$22/day; 1,420 vs ~60 tok MCP schemas; caveman/wenyan cuts | local Phase-0 measurements (see [01 — Token Economics and Measurement](/research/context/techniques/01-economics-and-measurement/), [02 — Baseline Audit of This Environment (Phase 0)](/research/context/techniques/02-baseline-audit/)) |
