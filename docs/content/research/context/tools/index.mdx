...
description: "Current comparison of token-optimization tools, their interception boundaries, evidence quality, composition, and best-fit workloads."
---
...
- [Token-optimization techniques](/research/context/techniques/) provides the cost model and full mechanism inventory.
- [Context engine design](/research/context/engine/) turns reviewed mechanisms into a capsule-native specification.
- [Context research](/research/context/) links the related dossiers.
