...
description: "Current lean-ctx design for repository search, retrieval, memory, compression, recovery, evidence, risks, and best fit."
---

## Summary

lean-ctx is an integrated context runtime rather than a single compressor, giving it broad reach but also the largest behavioral and ownership surface.
