...
**Research conducted:** 2026-07-03. Mission per the <RepoFile path="prompts/research/session-capture.md">research brief</RepoFile>: how SpecStory works, what else exists, what it means for jackin❯. This dossier is the evidence layer under the existing [Déjà Vu](/research/agents/orchestration/conversation-capture/deja-vu/) design proposal.
