...
description: "Dossier on coding-session capture mechanisms, products, native agent stores, market coverage, and jackin❯ integration options."
---
...
- <RepoFile path="prompts/research/session-capture.md">Session capture research brief</RepoFile>
