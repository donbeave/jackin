...
**Research state**: Findings from live Parallax data, not mock data. Collected on July 3, 2026 from `127.0.0.1:4000`, Parallax CLI, Parallax SQL, and the current jackin❯ codebase.
