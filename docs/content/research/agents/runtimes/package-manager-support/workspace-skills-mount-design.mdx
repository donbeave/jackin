...
description: "Evaluates a read-only workspace skill mount as a narrow fallback when native agent package managers cannot deliver local skills."
---

## Summary

A read-only workspace skill mount is only a fallback for local skills that native package managers cannot deliver; it must not become a second package system.
...
- [Native APM Support for jackin❯ Agent Roles](/research/agents/runtimes/package-manager-support/native-apm-role-support/)
