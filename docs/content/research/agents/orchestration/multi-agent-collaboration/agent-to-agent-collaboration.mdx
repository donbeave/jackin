...
**Research state**: Open — research and design proposal
...
- Historical donor `crates/jackin-tui/src/theme.rs` — palette tokens (`PHOSPHOR_*`, `STATUS_BLOCKED_RED`, `CAPSULE_PANE_FOCUSED`, `CAPSULE_MENU_AWAITING_BG`) the view consumed.
