...
description: "Designs a provider-neutral task-source contract for discovery, normalization, deduplication, polling, and dispatch."
---
...
A normalized task contract should isolate queue and workflow logic from GitHub, roadmap, file, stdin, and future provider-specific discovery mechanics.
...
- [Agent workflow orchestration](/research/agents/orchestration/workflow-systems/agent-workflow-orchestration/) — workflow-source and run-ledger direction
