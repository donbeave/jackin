...
**Research state**: Open — proposed research item (benchmarking reference for UX and worktree-native agent orchestration)
...
| Mobile companion (monitor, manage) | Yes | Lower priority; relevant to [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/jackin-desktop-agent-hub/) |
...
| Mobile companion | iOS + Android | Not yet; see [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/jackin-desktop-agent-hub/) |
...
The iOS/Android companion for remote monitoring and task management is an idea for the [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/jackin-desktop-agent-hub/) roadmap item, which uses the daemon as its state/event backend.
...
| Mobile companion | [jackin❯ desktop Agent Hub](/research/product/desktop/agent-hub/jackin-desktop-agent-hub/) |
