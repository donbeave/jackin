...
- Time-series graphs (sparklines, rolling 5-minute window) are outside this design; [usage surfaces](/commands/usage/) expose current provider limits rather than local usage trends.
