...
**Research state**: Design exploration for [Idle runtime cleanup hooks](/roadmap/idle-runtime-cleanup/) (Phase 4, [Agent Orchestration Program](/research/agents/orchestration/program-research/)). Nothing here has shipped yet; this page records the problem framing, the multicode precedent, the recommended shape, and the open questions for whoever builds it.
