...
description: "Examines how role and workspace metadata can expose stack-aware commands without hard-coding framework behavior."
---
...
Stack integration metadata should remain data-only, host-approved hints for commands, selectors, caches, and warnings rather than repository-controlled mounts or execution.
...
- [Agent Orchestration Program](/research/agents/orchestration/program-research/) — parent containment-track research.
