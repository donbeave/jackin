...
- [Container credential exposure](/research/platform/security/credential-exposure/container-credential-exposure/) — Phase 6 design state.
- [Reliable Claude authentication strategy](/research/agents/authentication/claude-auth-strategy/) — historical design context for the current `sync` / `token` / `ignore` mode set.
