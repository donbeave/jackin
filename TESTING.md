...
above. Governed PR CI runs the complete Desktop gate in the generated
`native-usage-menu-bar` lane (`.github/workflows/ci.yml`, generated by
velnor-actions-generator, invokes the reusable `velnor-actions`
`ci-native.yml`); that lane is the PR gate named in the verification matrix.
The `jackin` E2E
