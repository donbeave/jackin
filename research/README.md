...
|-------|------------------|---------|---------|
| [termrock-head-adoption](termrock-head-adoption/README.md) | Bump to TermRock head (pin `29a16b5b`) = measured 384-error mechanical migration + 40 applicable migration docs; brand chrome recolors on bump alone; PNG baseline pipeline adoptable as git dep; mouse cutover = proceed-with-compensations (19-rule matrix); facade retirement sequenced per-surface | termrock-migration | 2026-08-19 |
